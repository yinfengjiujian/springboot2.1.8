...
//        defaultWebSecurityManager.setCacheManager(new CustomCacheManager());
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(DefaultWebSecurityManager securityManager) {
        ...
        // Swagger接口文档
         ...
         //用户登录请求，需要放开 TODO  后续的注册等相关请求需要放开校验
         filterChainDefinitionMap.put("/system/sys-user/login", "anon");
         filterChainDefinitionMap.put("/system/sys-user/regist", "anon");
        // 公开接口
