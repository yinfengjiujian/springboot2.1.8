...
public class DateUtil {
     ...
     *
     * @param source
     * @param patterns 日期格式串如yyyy -MM-dd HH:mm:ss
     * @return
     */
     ...
     */
    public static Date getUtilDate(java.sql.Timestamp timestamp) {
        if (timestamp == null) {
            return null;
        }
     ...
     */
    public static java.sql.Timestamp getSQLTimeStamp(Date utilDate) {
